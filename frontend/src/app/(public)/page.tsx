...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden hero-pattern pt-20 pb-28 md:pt-28 md:pb-36 border-b border-[#C5A880]/15">
        {/* Subtle radial ambient glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[350px] bg-[#C5A880]/10 rounded-full blur-[140px] pointer-events-none"></div>
        <div className="absolute top-10 right-10 w-72 h-72 bg-[#172A45]/40 rounded-full blur-3xl pointer-events-none"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-6">
            
            {/* Prestige badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#172A45]/90 border border-[#C5A880]/40 text-xs font-semibold text-[#DFC7A5] tracking-wide shadow-md">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15]">
              ...
              <span className="gold-gradient-text">Decisive Landmark Results.</span>
            </h1>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl text-base font-bold text-[#0A192F] bg-gradient-to-r from-[#DFC7A5] via-[#C5A880] to-[#9F8259] hover:brightness-110 shadow-xl shadow-[#C5A880]/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
              >
              ...
              <Link
                href="/case-results"
                className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-xl text-base font-semibold text-white bg-[#172A45]/60 hover:bg-[#172A45] border border-white/10 hover:border-[#C5A880]/40 transition"
              >
            ...
            {/* Trust Badges */}
            <div className="pt-8 flex flex-wrap items-center gap-6 sm:gap-10 border-t border-white/10 text-xs text-slate-400">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#C5A880]" />
                <span>Zero Fee Unless We Win</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#C5A880]" />
                <span>24/7 Confidential Response</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#C5A880]" />
                <span>Former Federal Prosecutors</span>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#0A192F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            <Link
              href="/practice-areas"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#DFC7A5] hover:text-white transition"
            >
      ...
      {/* 4. WHY CHOOSE APEX LEGAL (THE TRIAL DIFFERENCE) */}
      <section className="py-20 bg-[#0B192C] border-y border-[#1E2D4A] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                <div className="p-4 rounded-xl bg-[#0A192F] border border-white/5 space-y-2">
                  ...
                  <p className="text-xs text-slate-400">Over 45+ jury verdicts taken to verdict with a 98.6% favorable outcome rate.</p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#0A192F] border border-white/5 space-y-2">
                  ...
                  <p className="text-xs text-slate-400">Partners include former AUSAs and federal enforcement directors from SDNY.</p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#0A192F] border border-white/5 space-y-2">
                  ...
                  <p className="text-xs text-slate-400">In personal injury matters, you pay zero legal fees unless we successfully recover.</p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#0A192F] border border-white/5 space-y-2">
                  ...
                  <p className="text-xs text-slate-400">Your legal strategy is guided by senior partners, never handed off to junior associates.</p>
                </div>
              </div>
            </div>

            {/* Right Column Image & Legal Seal */}
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden border border-[#C5A880]/30 shadow-2xl h-[420px]">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#060D17] via-transparent to-transparent"></div>
                <div className="absolute bottom-6 left-6 right-6 p-6 rounded-xl bg-[#0A192F]/90 backdrop-blur-md border border-[#C5A880]/20">
                  <span className="text-[11px] font-bold uppercase tracking-wider text-[#C5A880] block">Tier 1 National Law Firm</span>
      ...
      <section className="py-20 bg-[#0A192F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <Link
              href="/attorneys"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-wider text-[#DFC7A5] bg-[#172A45] hover:bg-[#1E2D4A] border border-[#C5A880]/30 transition"
            >
      ...
      <section className="py-20 bg-[#060D17] border-y border-[#1E2D4A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-20 bg-[#0A192F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-7 rounded-2xl bg-[#0B192C] border border-white/5 relative flex flex-col justify-between">
      ...
      <section className="py-20 bg-[#0B192C] border-t border-[#C5A880]/20">
